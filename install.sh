...
echo 'alias hostnim="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/hostnim/Core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/hostnim/Core'"
...
rm -rf "$HOME/.config/@hostnim"
rm -rf "$HOME/.config/@hostnim"
rm -rf "$HOME/.config/hostnim-core"
